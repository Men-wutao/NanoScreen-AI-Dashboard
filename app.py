...
# ----------------------------
    ...
    if all_scored_path.exists():
        ...
        scored_df = read_csv_safely(all_scored_path)

        generated_count = len(scored_df)
...
# ----------------------------
    ...
    range_path = DATA_DIR / "range_recommendation_CT_Breast.csv"
    ...
    if range_path.exists():
        ...
        range_df = read_csv_safely(range_path)
        ...
        st.error(
            "data/range_recommendation_CT_Breast.csv was not found."
        )
